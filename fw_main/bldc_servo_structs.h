...
struct BldcServoStatus {
  ...
  float rls_R_hat = 0.0f; // Khai bao bien rls_R_hat

  float asmo_w_hat = 0.0f; // Khai bao bien asmo_w_hat
  float asmo_theta_hat = 0.0f; // Khai bao bien asmo_theta_hat
  ...
  template <typename Archive> void Serialize(Archive *a) {
    ...
    a->Visit(MJ_NVP(asmo_w_hat)); // Them asmo_w_hat vao Serialize
    a->Visit(MJ_NVP(asmo_theta_hat)); // Them asmo_theta_hat vao Serialize
